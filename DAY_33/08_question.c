...
#include <stdio.h>
void printBinaryOfDecimalNumberLoop(int n); // it print the binary of given number..
void pushData(int *ptr, int size, int data, int lastFilledIndex); // pushing data into the arry..
void displayArrayData(int *ptr, int lastFilledIndex); // displaying the array data.
void reverseArrayData(int *ptr, int lastFilledIndex); // reversing the binary we got get it correct binary...
void formatBinary(int *ptr, int size, int lastFilledIndex); // for the formating in 8 bits
int main()
{
    int n;
...
// do its recursive approach also......